...
<h3><font color="#0000FF"> INFORMASI TARIF</font></h3>
  ...
  if(!isset($_REQUEST['submit'])) {
	  ?>
      <center><h3><font color="#FF0000">DAFTAR ANGKOT CV MORINA </font></h3></center>
      <h4>No Angkot:75   Rute:IKIP UNIMED-BAGAN DELI-PP</h4> <h4>No Angkot:80 Rute: PERUMNAS MARTUBUNG-TJ SELAMAT-PP</h4><h4>No Angkot:81 Rute:AMPLAS-BELAWAN-PP </h4><h4>No Angkot:139 Rute:LEDDA SUJONO-TERMINAL BELAWAN-PP </h4><h4>No Angkot:139 Rute:LEDDA SUJONO-TERMINAL BELAWAN-PP </h4><h4>No Angkot:140 Rute:TERMINAL PINANG BARIS-LETDA SUJONO-PP </h4><h4>No Angkot:143 Rute:SIMALINGKAR-TEMBUNG-PP </h4>
      <?php
  } else {
  ?>
