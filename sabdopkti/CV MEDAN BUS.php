...
<h3><font color="#0000FF"> INFORMASI TARIF</font></h3>
  ...
  if(!isset($_REQUEST['submit'])) {
	  ?>
      <center><h3><font color="#FF0000">DAFTAR ANGKOT MEDAN BUS</font></h3></center>
      <h4>No Angkot:11   Rute:TJ MORAWA-BELAWAN-PP</h4> <h4>No Angkot:36 Rute: JL KARYA WISATA-TEMBUNG-PP</h4><h4>No Angkot:45 Rute:PINANG BARIS-TEMBUNG-PP </h4><h4>No Angkot:47 Rute:PINANG BARIS-MANDALA-PP </h4><h4>No Angkot:135 Rute:AMPLAS-PADANG BULAN-USU-HELVETIA-PP </h4>
      <?php
  } else {
  ?>
