...
<h3><font color="#0000FF"> INFORMASI TARIF</font></h3>
  ...
  if(!isset($_REQUEST['submit'])) {
	  ?>
      <center><h3><font color="#FF0000">DAFTAR ANGKOT PU GAJAH MADA </font></h3></center>
      <h4>No Angkot:TR 96   Rute:MARTUBUNG-TUNTUNGAN-PP</h4> <h4>No Angkot:TR 97 Rute: PASAR PETISAH-SELAMAT UJUNG-PP</h4><h4>No Angkot:TR 98 Rute:T.PINANG BARIS-NAMO GAJAH-PP </h4>
      <?php
  } else {
  ?>
