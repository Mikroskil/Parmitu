...
<h3><font color="#0000FF"> INFORMASI TARIF</font></h3>
  ...
  if(!isset($_REQUEST['submit'])) {
	  ?>
      <center><h3><font color="#FF0000">DAFTAR ANGKOT PT NASIONAL </font></h3></center>
      <h4>No Angkot:38  Rute: TANJUNG ANOM-T. AMPLAS-PP</h4> <h4>No Angkot:17 Rute: PD BULAN-SAMBU-PP</h4><h4>No Angkot:10 Rute:SIMALINGKAR-SAMBU-PANCING-PP </h4><h4>No Angkot:K 04 Rute:SIMALINGKAR-BATAS KOTA-PP </h4><h4>No 
      Angkot:M 28 Rute:SIMALINGKAR-R.SALEH-VETERAN-PP </h4><h4>No Angkot:M 29 Rute:SP SELAYANG-LETDA SUJONO-PP </h4>
      <?php
  } else {
  ?>
