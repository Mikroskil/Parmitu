...
<h3><font color="#0000FF"> INFORMASI TARIF</font></h3>
  ...
  if(!isset($_REQUEST['submit'])) {
	  ?>
      <center><h3><font color="#FF0000">DAFTAR ANGKOT PT POVRI</font></h3></center><h4>No Angkot:04   Rute:PERUM INDAH-IKIP BARU-PP</h4> <h4>No Angkot:05 Rute: DELI TUA-VETERAN/P.PASAR-PP</h4><h4>No Angkot:15 Rute:TITI KUNING-TEMBUNG-PP </h4><h4>No Angkot:23 Rute:P.SIMALINGKAR-KAPTEN MJAMIL LUBIS-PP</h4><h4>No Angkot:25 Rute: T.AMPLAS-JL SISINGAMANGARAJA-PP</h4>
      <?php
  } else {
  ?>
