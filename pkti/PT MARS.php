...
<h3><font color="#0000FF"> INFORMASI TARIF</font></h3>
  ...
  if(!isset($_REQUEST['submit'])) {
	  ?>
      <center><h3><font color="#FF0000">DAFTAR ANGKOT PT.MARS</font></h3></center>
      <h4>No Angkot:13   Rute:P.MANDALA-TJ.GUSTA SUKADONO-PP</h4> <h4>No Angkot:60 Rute: AKSARA-HAYAM WURUK-PD BULAN-PASAR I-PP</h4><h4>No Angkot:61 Rute:SIMALINGKAR-PADANG BULAN-BELAWAN-PP </h4><h4>No Angkot:65 Rute: TEMBUNG BELAWAN-PP</h4><h4>No Angkot:70 Rute: P.MANDALA-T.P BARIS-PP</h4>
      <?php
  } else {
  ?>
